      ...
      <main className="py-10 min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50">
        <Container>
          <div className="max-w-2xl mx-auto">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-ink-900 mb-2">Your Event Pass</h1>
              <p className="text-ink-600">View and download your event pass with all guest details</p>
            </div>

            {passes.length === 0 ? (
              <div className="bg-white rounded-xl p-8 text-center border border-violet-200">
                <p className="text-ink-600">No event pass found for this booking.</p>
              </div>
            ) : (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-ink-600 mb-3">
                          This pass includes all guests for your booking
                        </p>
